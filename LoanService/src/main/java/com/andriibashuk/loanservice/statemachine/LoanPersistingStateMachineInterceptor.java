...
@Log
@Service
public class LoanPersistingStateMachineInterceptor <S, E, T> extends StateMachineInterceptorAdapter<S, E>
    ...
    private final LoanRepositoryStateMachinePersist<S, E> persist;

    public LoanPersistingStateMachineInterceptor(LoanStateMachineRepository loanRepository) {
        persist = new LoanRepositoryStateMachinePersist<S, E>(loanRepository);
    }
