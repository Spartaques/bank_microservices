...
@Log
@Service
public class ApplicationPersistingStateMachineInterceptor<S, E, T> extends StateMachineInterceptorAdapter<S, E>
    ...
    private final ApplicationRepositoryStateMachinePersist<S, E> persist;

    public ApplicationPersistingStateMachineInterceptor(ApplicationStateMachineRepository applicationStateMachineRepository) {
        persist = new ApplicationRepositoryStateMachinePersist<S, E>(applicationStateMachineRepository);
    }
